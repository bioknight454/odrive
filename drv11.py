...
odrv0.config.dc_max_negative_current = -30 #-2
...
odrv0.axis0.motor.config.current_lim = 50  # Lower current limit to avoid overcurrent violation
...
odrv0.axis1.motor.config.current_lim = 50  # Lower current limit to avoid overcurrent violation
